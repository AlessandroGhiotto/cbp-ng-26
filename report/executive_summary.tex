...
\begin{table}[htbp]
    ...
    \texttt{tage\_bimodeL}       & 16 KB  & 0.471 & 9.74 & 2.59 & 1587 \\
    \hline
    ...
    \texttt{tage\_bimodeL}       & 8 KB  & 0.494 & 12.23 & 2.84 & 1038 \\
...
\vspace{0.2cm}
\textbf{TAGE bimode.} \\
This variant replaces the simple bimodal base predictor ($t_0$) with a Bi-Mode predictor~\cite{lee1997bimode}, for increasing the accuracy of the base predictor. However, under strict memory budgets (8~KB and 16~KB), the choice table, taken PHT, and not-taken PHT consume a significant fraction of the storage. This severely limits the capacity of the TAGE tagged tables, forcing them to use short tags and fewer rows, causing the average MPKI to degrade to 9.74 (compared to 5.42 for \texttt{tageL}). Additionally it consumes also more energy than a bimodal base predictor.
