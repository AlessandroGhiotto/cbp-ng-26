...
\vspace{0.2cm}
\textbf{TAGE bimode.} \\
This variant replaces the simple bimodal base predictor ($t_0$) with a choice-directed Bi-Mode predictor. However, under strict memory budgets (8~KB and 16~KB), the choice table, taken PHT, and not-taken PHT consume a significant fraction of the storage. This severely limits the capacity of the TAGE tagged tables, forcing them to use short 8-bit tags and fewer rows, causing the average MPKI to degrade to 9.74 (compared to 5.42 for \texttt{tageL}). Additionally it consumes also more energy than a bimodal basae predictor.
