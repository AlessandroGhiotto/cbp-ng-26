    ...
    \begin{columns}[T]
        ...
        \begin{block}{SRAM Access Amortization}
            \begin{itemize}
                ...
                \item \textbf{Register Reuse:} cache active row bits to skip subsequent lookups.
            \end{itemize}
        \end{block}
...
\begin{frame}{Proposed Methodologies: TAGE Bimode}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Concept \& Motivation}
            \begin{itemize}
                \item \textbf{Choice-Directed Base Table:} splits predictions into separate taken/not-taken tables.
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Core Mechanism}
            \begin{itemize}
                ...
                \item \textbf{Dynamic Bypass:} bypasses tagged SRAM lookups ($t_1, t_2, t_3$).
            \end{itemize}
        \end{block}
        \vspace{0.05cm}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Key Results \& Insights}
            \begin{itemize}
                ...
                \item \textbf{Energy Savings:} \texttt{tage\_satL} cuts EPI by \textbf{14.6\%} (16~KB) and \textbf{21.3\%} (8~KB) vs. \texttt{tageL} \hyperlink{block_8kb}{\beamerbutton{8KB Table}}.
