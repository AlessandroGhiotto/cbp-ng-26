...
\begin{frame}{Introduction}
    ...
    \begin{block}{Goals}
        \begin{itemize}
            \item \textbf{Exploration:} benchmark classical predictors under \textbf{8~KB} and \textbf{16~KB} HW budgets.
            \item \textbf{TAGE Proposal:} design and evaluate an optimized low-power version of TAGE.
    ...
    \begin{columns}[T]
        ...
        \begin{block}{SRAM Access Amortization}
            \begin{itemize}
                ...
                \item \textbf{Block Prediction:} predicts up to $16$ instructions in a single wide SRAM row access.
...
\begin{frame}{Proposed Methodologies: TAGE bimode}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Resource Constraints \& Aliasing}
            \begin{itemize}
                \item \textbf{Storage Overhead:} base table consumes storage budget. So it forces short tags, and increases aliasing for the tagged tables (\textbf{5.64 MPKI}).
                \item \textbf{Higher Complexity:} high power consumption (\hyperlink{block_16kb}{\textbf{1369 fJ EPI}}).
            \end{itemize}
        \end{block}
    ...
    \begin{columns}[T]
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{lcccc}
                ...
                \textbf{\texttt{tage\_bimodeL}} & 0.5255 & 5.64 & 2.7612 & 1369.2 \\
                \midrule
...
\begin{frame}{Conclusions}
    \begin{block}{Results}
        \begin{itemize}
            ...
            \item \textbf{Complexity Penalty:} architectural extensions may degrade timing and storage efficiency.
        \end{itemize}
    \end{block}
    \begin{block}{Other ideas}
        \begin{itemize}
            \item \textbf{Mixing Predictors:} combine smaller, specialized predictors. \\
            Send branches to the simplest accurate predictor to save energy.
        \end{itemize}
    \end{block}
\end{frame}
