...
def main():
    ...
    fig.suptitle("bimodeL Predictor: Superscalar Design Space Sweep", fontsize=18, fontweight='bold', y=0.98)
    ...
    ax4.set_title("Top 5 bimodeL Configurations (VFS Score)", fontsize=13, fontweight='bold', pad=15)
