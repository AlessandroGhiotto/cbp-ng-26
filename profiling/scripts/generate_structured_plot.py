...
# Data
models = ["gagL", "gapL", "pagL", "papL", "bimodeL"]
vfs_8kb = [0.4881, 0.4725, 0.4101, 0.4232, 0.4715]
vfs_16kb = [0.4872, 0.4718, 0.3163, 0.3283, 0.4720]

mpki_8kb = [11.63, 12.99, 15.11, 14.07, 11.36]
mpki_16kb = [11.71, 13.00, 14.85, 12.87, 11.32]

ipc_8kb = [2.56, 2.52, 2.20, 2.24, 2.46]
ipc_16kb = [2.56, 2.52, 1.56, 1.58, 2.47]

epi_8kb = [146.0, 149.0, 422.0, 299.0, 458.0]
epi_16kb = [181.0, 185.0, 346.0, 321.0, 501.0]
